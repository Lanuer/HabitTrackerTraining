package com.example.habittrackertraining.ui.fragments.habitlist.adapters
...
import com.example.habittrackertraining.ui.fragments.habitlist.HabitListDirections
...
class HabitListAdapter: RecyclerView.Adapter<HabitListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HabitListAdapter.MyViewHolder, position: Int) {
        ...
        holder.itemView.tv_timeElapsed.text = Calculations.calculaterTimeBetweenDates(currentHabit.habit_startTime)
        holder.itemView.tv_item_createdTimeStamp.text = "開始時間: ${currentHabit.habit_startTime}"
    }
